...
text_in_google = "546547657567rhffdhbfddfhdfhfdbfbbbdf"
...
def test_search_google():
    ...
    start_page.search_information(text_in_google)

    time.sleep(3)
    text_google = driver.find_element(By.XPATH, "//p[@aria-level='3' and text()='По запросу ']")
    value_text = text_google.text
    assert value_text == f"По запросу " + text_in_google + " ничего не найдено. "
    driver.quit()